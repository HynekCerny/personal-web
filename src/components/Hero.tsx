                ...
                gap-6 items-center">
                    ...
                    md:justify-end space-x-4 mt-4 md:mt-0">
                        <button onClick={handleClick}
                            className="cursor-pointer px-4 lg:px-8 py-3 text-base lg:text-xl bg-white dark:bg-gray-800 text-blue-700 dark:text-gray-300 border-2 border-blue-700 dark:border-gray-400 rounded-lg dark:hover:text-blue-700 dark:hover:border-blue-700 hover:bg-blue-100 dark:hover:bg-gray-800 transition-colors flex items-center space-x-2 mt-4 md:mt-0 justify-center">
