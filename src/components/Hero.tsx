                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="flex justify-center md:justify-end space-x-4 mt-4 md:mt-0">
                        <button onClick={handleClick}
                            className="cursor-pointer px-4 lg:px-8 py-3 text-base lg:text-xl bg-white dark:bg-transparent text-blue-700 dark:text-gray-400 border-2 border-blue-700 dark:border-gray-400 rounded-lg dark:hover:text-blue-900 dark:hover:border-blue-900 hover:bg-blue-100 transition-colors flex items-center space-x-2 mt-4 md:mt-0 justify-center">
                            <span>View Experience</span>
                        </button>

                        <button
                            onClick={() => window.open('https://linkedin.com/in/hynekcerny', '_blank', 'noopener,noreferrer')}
                            className="cursor-pointer px-4 lg:px-8 py-3 text-base lg:text-xl bg-blue-700  text-white rounded-lg border-2 border-blue-700  hover:bg-blue-100 hover:text-blue-700 dark:hover:text-blue-900 hover:border-blue-700 dark:hover:border-blue-900 transition-colors flex items-center space-x-2 mt-4 md:mt-0 justify-center"
                        >
