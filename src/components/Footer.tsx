...
const Footer = () => {
  return (
    <footer className="fade-in bottom-0 left-0 z-20 w-full p-4 border-t-2 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 dark:text-gray-400 md:p-6">
